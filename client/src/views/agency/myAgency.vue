  ...
  <div class="proListBox">
    ...
    <div class="proListTable">
      <el-table :data="proData" style="width: 100%" border>
        <el-table-column prop="username" label="代理帐号"></el-table-column>
        <el-table-column prop="level" label="代理等级"></el-table-column>
        <el-table-column prop="phone" label="电话"></el-table-column>
        <el-table-column prop="debt" label="欠款金额"></el-table-column>
        <el-table-column label="操作" width="300">
          <template slot-scope="scope">
            <el-button size="mini" @click="lookOrderPro(scope.row)" type="primary">查看明细</el-button>
            <el-button size="mini" @click="lookOrderPro(scope.row)" type="success">还款</el-button>
          </template>
        </el-table-column>
      </el-table>
