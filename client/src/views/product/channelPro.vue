<template>
    <div class="channelProBox">
        ...
        <div class="header"><a href="模板.xlsx" download="模板.xlsx">导入模板</a></div>
        <el-form label-position="left" label-width="80px" :model="form" class="elForm">
            ...
            <el-form-item label="上传excel">
                <input type="file" @change="exportData" ref="excelFile"
                    accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel"
                    class="fileInput" /> <span v-if="delFile" class="delFile" @click="delFileFun">删除文件</span>
            </el-form-item>
            <el-button type="primary" class="elButton">上传</el-button>
        </el-form>
    </div>
</template>
<script>
            ...
            exportData(event) {
                ...
                FileReader.prototype.readAsBinaryString = function (f) {
                    ...
                    reader.onload = function (e) {
                        ...
                        that.delFile = true;
                        that.excelList = XLSX.utils.sheet_to_json(wb.Sheets[wb.SheetNames[0]])
                    }
